...
import styles from "../../css/View_Single_Student_Data.module.css";


export default function ViewSingleStudentDetail() {
  const { id } = useParams();
  ...
  const fetchStudentDetails = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5005/admin/dashboard/view-student/${id}`, {
            credentials : 'include',
        }
      );
    ...
    return (
      <div className={styles.container}>
        <div className={styles.errorContainer}>
          ...
          <p>{error}</p>
          <button onClick={fetchStudentDetails} className={styles.retryButton}>
            Try Again
          </button>
        </div>
      </div>
    ...
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        ...
        <div className={styles.headerTitle}>
          ...
          <p>Complete information and details</p>
        </div>
          ...
          <div className={styles.detailsContainer}>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.infoGrid}>
                    ...
                    <span className={styles.genderBadge}>
                      {student.gender === "Male" ? (
                        <svg
                          ...
                          fill="currentColor"
                        >
                          <path d="M10.5 1.875a1.125 1.125 0 012.25 0v8.219c.517.162 1.02.382 1.5.652V3.375a1.125 1.125 0 012.25 0v6.75c0 .621.504 1.125 1.125 1.125H20.25a1.125 1.125 0 010 2.25h-2.625a1.125 1.125 0 01-1.125-1.125v-6.75a4.5 4.5 0 11-9 0v8.219a6.75 6.75 0 101.5-4.031V1.875z" />
                        </svg>
                      ) : (
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                ...
                <div className={styles.infoItem}>
                  ...
                  <span className={styles.infoValue}>{student.rollNumber}</span>
                </div>
                <div className={styles.infoItem}>
            ...
            <div className={styles.section}>
              ...
              <div className={styles.infoGrid}>
                ...
                <div className={styles.infoItem}>
                  <span className={styles.infoLabel}>Mother's Name</span>
